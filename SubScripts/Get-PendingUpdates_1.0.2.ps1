...
Function Get-PendingUpdates {
	...
	If ($Global:GetPendingUpdates) {
		Remove-Variable GetPendingUpdates -Scope "Global"
	}
...
#        Write-Warning "Create COM Object Failure" 
	...
	$Global:GetPendingUpdates = New-Object -TypeName PSObject -Property @{
...
1.0.2 - 01/22/2013
	Renamed Function from PendingPatches to PendingUpdates
#>

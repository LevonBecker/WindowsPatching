...
Function Show-WPMDefaultsMissingError {
...
Write-Host '     Set-WindowsPatchingDefaults -vCenter "vcenter01.domain.com" -UpdateServerURL "https://wsus01.domain.com" -Quiet'
Write-Host '}'
Write-Host ''
Break

...
#	. "$SubScripts\Func_Get-ExitCodeDescription_1.0.0.ps1"
...
1.0.9 - 12/14/2012
	Removed cross reference table for getting the exitcode description and moved it to
		a subscript named Func_Get-ExitCodeDescription that has all the Windows System
		Error Codes and not just a few I hand picked.
1.0.9 - 12/20/2012
	Fixed missing Func_ from Get-ExitCodeDescription dot sourcing
#>

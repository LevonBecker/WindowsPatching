...
#region Variables
	...
	# FILENAMES
	[string]$ResultsTextFileName = "Move-WSUSClientToGroup_Results_" + $FileDateTime + $TimeZoneString + "_($HostInputDesc).log"
	[string]$ResultsCSVFileName = "Move-WSUSClientToGroup_Results_" + $FileDateTime + $TimeZoneString + "_($HostInputDesc).csv"
